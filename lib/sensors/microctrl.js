...
var getMicroctrl = () => {
  ...
  // var ao1             = bufferize(ao1Bytes, 0) / 1000
  // var ao2             = bufferize(ao2Bytes, 0) / 1000
  ...
  var out             = bufferize(outBytes, 0) / 1000
  // more fetures. to be done...
  ...
  microcrtl.emit("new_data", {
    ...
    ign_vhigh: ign_vhigh,
    pwron_src: pwron_src,
    pwroff_src_prev: pwroff_src_prev,
    pwroff_src: pwroff_src,
    pwroff_stat: pwroff_stat,
    pwroff_soft_to: pwroff_soft_to,
    pwroff_hard_to: pwroff_hard_to,
    pwroff_soft: pwroff_soft,
    pwroff_hard: pwroff_hard,
    pwroff_vlow: pwroff_vlow,
    pwron_vhigh: pwron_vhigh,
    hwid: hwid,
    blid: blid,
    fwid: fwid,
    time: time,
